...
| Datum | Änderung |
|---|---|
| 20.06.2026 | **„Neues Ticket"-Symbol ist jetzt ein echtes Ticket** (`components/Sidebar.tsx`): Das bisherige `TicketPlusIcon` wirkte nicht wie ein Ticket. Ersetzt durch das Tabler-Symbol `ti-ticket` (Eintrittskarte mit Kerbe), passend zu den übrigen `ti-`-Menü-Icons. Ungenutzter Import entfernt. |
