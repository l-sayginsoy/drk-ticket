...
export const DEFAULT_APP_SETTINGS: AppSettings = {
    ...
    ticketCategories: [
        { id: 'cat-sicherheit', name: 'Sicherheit / Brandschutz', default_priority: Priority.Hoch },
        { id: 'cat-gebaeudetechnik', name: 'Haustechnik', default_priority: Priority.Mittel },
        { id: 'cat-it', name: 'IT / EDV', default_priority: Priority.Mittel },
        { id: 'cat-hauswirtschaft', name: 'Hauswirtschaft', default_priority: Priority.Niedrig },
    ...
    slaMatrix: [
        { id: 'sla-1', categoryId: 'cat-sicherheit', priority: Priority.Hoch, responseTimeHours: 2 },
        { id: 'sla-2', categoryId: 'cat-sicherheit', priority: Priority.Mittel, responseTimeHours: 8 },
        { id: 'sla-3', categoryId: 'cat-gebaeudetechnik', priority: Priority.Hoch, responseTimeHours: 4 },
        { id: 'sla-4', categoryId: 'cat-gebaeudetechnik', priority: Priority.Mittel, responseTimeHours: 24 },
        { id: 'sla-5', categoryId: 'cat-it', priority: Priority.Hoch, responseTimeHours: 8 },
        { id: 'sla-6', categoryId: 'cat-hauswirtschaft', priority: Priority.Mittel, responseTimeHours: 48 },
    ],
    routingRules: [
        { id: 'route-1',  skill: 'HLKW',          keyword: 'Heizung,Heizkörper,warm,kalt,Lüftung,Klimaanlage,Klima,Wasser,heiß,Thermostat,Ventil,Heizungsausfall,friert,Zugluft,Belüftung,Abluft' },
        { id: 'route-2',  skill: 'Sanitär',        keyword: 'Abfluss,Rohr,Toilette,WC,verstopft,läuft über,Waschbecken,Dusche,Badewanne,Wasserhahn,tropft,Spülung,Geruch,Abwasser,Pflegebad' },
        { id: 'route-3',  skill: 'Elektrik',       keyword: 'Strom,Licht,Sicherung,Steckdose,Lampe,Birne,leuchtet nicht,Kurzschluss,Schalter,Notlicht,Klingel,Türklingel,Gegensprechanlage,ausgefallen' },
        { id: 'route-4',  skill: 'IT',             keyword: 'WLAN,Internet,Netzwerk,Drucker,Computer,PC,Telefon,Telefonanlage,Bildschirm,Tastatur,Router,Passwort,Anschluss,Kabel,langsam' },
        { id: 'route-5',  skill: 'Hauswirtschaft', keyword: 'Wäsche,dreckig,Fleck,Reinigung,putzen,sauber,Boden,schmutzig,Mülleimer,Abfall,Küche,Geschirr,Spülmaschine,Waschmaschine,Trockner,Bügeln,Bügeleisen,Handtuch,Bettwäsche,Bezug,Laken' },
        { id: 'route-6',  skill: 'Medizintechnik', keyword: 'Bett,Pflegebett,Aufstehhilfe,Rollstuhl,Rollator,Lifter,Arjo,Waage,Blutdruckmessgerät,Inhalator,Absauggerät,Badewannenlift,Rufanlage,Notruf,Nachtlicht' },
        { id: 'route-7',  skill: 'Haustechnik',    keyword: 'Fenster,Tür,Schloss,klemmt,Riss,Wand,Decke,Fliese,Tapete,streichen,Schimmel,feucht,nass,Wasserschaden,undicht,Dach,Keller,Raum,Zimmer,richten,vorbereiten,aufbauen,umstellen,Möbel,Tische,Stühle,Schrank,umräumen,herrichten,Besprechung' },
        { id: 'route-8',  skill: 'Außenanlage',    keyword: 'Außen,Hof,Einfahrt,Parkplatz,Weg,Gehweg,Beleuchtung außen,Laterne,Mülltonne,Container,Absperrung,Zaun,Tor,Schranke,Schnee,Eis,rutschig' },
        { id: 'route-9',  skill: 'Garten',         keyword: 'Garten,Rasen,Hecke,Baum,Büsche,mähen,schneiden,pflanzen,Blumen,Beete,Grünfläche,harken,Laub' },
        { id: 'route-10', skill: 'Brandschutz',    keyword: 'Brandschutz,Feuerlöscher,Rauchmelder,Fluchtwächter,Fluchtweg,Notausgang,Brandschutztür,Feuertür,Alarm,piept,Brandmeldeanlage,Sprinkler,Notbeleuchtung,Schließanlage' },
        { id: 'route-11', skill: 'Dekoration',     keyword: 'Dekoration,Deko,Weihnachten,Ostern,Advent,schmücken,aufhängen,abnehmen,Weihnachtsbaum,Kerzen,Girlande,Fest,Veranstaltung,Aufbau,Abbau,Gottesdienst,Kapelle,Andacht,Messe,Altar,Bestuhlung,Mikrofon,Lautsprecher' },
    ],
    routineSchedules: [],
