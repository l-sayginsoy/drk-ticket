...
export const DEFAULT_APP_SETTINGS: AppSettings = {
    ...
    routingRules: [
        { id: 'route-1', keyword: 'Heizung,Heizkörper,Thermostat,Lüftung,Klima,Klimaanlage,Kalt,Warm,Wärme,Temperatur,Kühlung', skill: 'HLKW' },
        { id: 'route-2', keyword: 'Wasser,Abfluss,Rohr,Toilette,WC,Dusche,Waschtisch,Waschbecken,Verstopfung,Wasserhahn,Undicht,Tropft,Bad', skill: 'Sanitär' },
        { id: 'route-3', keyword: 'Strom,Licht,Sicherung,Steckdose,Leuchte,Lampe,Ausfall,Elektrik,Klingel,Schwesternruf,Aufzug,Lift', skill: 'Elektrik' },
        { id: 'route-4', keyword: 'WLAN,Netzwerk,Drucker,PC,Computer,EDV,Internet,Tablet,Telefon,Router,Monitor,Bildschirm', skill: 'IT' },
        { id: 'route-5', keyword: 'Wäsche,Reinigung,Putzen,Boden,Fenster,Küche,Speisesaal,Wohnbereich,Sauberkeit,Hygiene,Müll,Entsorgung', skill: 'HW' },
        { id: 'route-6', keyword: 'Garten,Rasen,Baum,Hecke,Grünanlage,Außen,Außenbereich,Parkplatz,Einfahrt,Terrasse,Weg,Schnee,Laub', skill: 'Garten' },
    ],
    routineSchedules: [],
